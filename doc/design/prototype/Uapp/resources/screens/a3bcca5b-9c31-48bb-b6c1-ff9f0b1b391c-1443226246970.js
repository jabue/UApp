jQuery("#simulation")
  .on("click", ".s-a3bcca5b-9c31-48bb-b6c1-ff9f0b1b391c .click", function(event, data) {
  ...
  .on("pageload", ".s-a3bcca5b-9c31-48bb-b6c1-ff9f0b1b391c .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
