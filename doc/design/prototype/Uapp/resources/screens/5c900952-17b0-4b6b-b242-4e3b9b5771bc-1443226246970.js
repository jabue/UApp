jQuery("#simulation")
  .on("click", ".s-5c900952-17b0-4b6b-b242-4e3b9b5771bc .click", function(event, data) {
  ...
  .on("pageload", ".s-5c900952-17b0-4b6b-b242-4e3b9b5771bc .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-5c900952-17b0-4b6b-b242-4e3b9b5771bc .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-5c900952-17b0-4b6b-b242-4e3b9b5771bc .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
